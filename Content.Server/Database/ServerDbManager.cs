...
namespace Content.Server.Database
{
    public interface IServerDbManager
    {
        ...
        Task<ServerBanDef?> GetLastServerBanAsync(); //_Paradox-Tweak: Логи банов для диса
        ...
        Task<ServerRoleBanDef?> GetLastServerRoleBanAsync(); //_Paradox-Tweak: Логи банов для диса
    ...
    public sealed class ServerDbManager : IServerDbManager
    {
        ...
        // Start-_Paradox-start: логи банов для диса
